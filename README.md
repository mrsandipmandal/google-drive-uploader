...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/open/google-drive-uploader.svg?style=flat-square)](https://packagist.org/packages/open/google-drive-uploader)
[![Total Downloads](https://img.shields.io/packagist/dt/open/google-drive-uploader.svg?style=flat-square)](https://packagist.org/packages/open/google-drive-uploader)
[![License](https://img.shields.io/packagist/l/open/google-drive-uploader.svg?style=flat-square)](https://packagist.org/packages/open/google-drive-uploader)
...
```bash
composer require open/google-drive-uploader
```
